...
import 'package:razorpay_integration_app/componets/app_components.dart';
import 'package:razorpay_integration_app/paymentservice/paymentservice.dart';
...
class _PurchaseViewState extends State<PurchaseView> implements PaymentService {
  ...
  final _razorpayKey = "PLACE YOUR API KEY HERE";
  ...
  void openRazorPaySession(int price, String productName,
    ...
    try {
      var options = {
        ...
        'prefill': {'contact': '+918320809751', 'email': 'shubham@yopmail.com'}
      };
